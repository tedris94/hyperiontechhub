-- DEPRECATED: legacy pre-Payload schema (uuid ids). Do not apply on a Payload database.
-- Payload replaces these tables via npm run migrate / migrate:chunked.
-- If these tables exist, run: npm run db:reset
