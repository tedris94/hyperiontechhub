...
export const ALL_CAPABILITIES = [
  ...
  { key: 'cms.portfolio.manage', label: 'Manage portfolio cases', group: 'Content' },
...
export const DASHBOARD_MENU: DashboardMenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Portfolio', path: '/dashboard/cms/portfolio', capability: 'cms.portfolio.manage' },
...
export const ROUTE_CAPABILITIES: Record<string, string | string[]> = {
  ...
  '/dashboard/cms/portfolio': 'cms.portfolio.manage',
